      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-6 auto-rows-[180px] gap-4">
          ...
          <motion.div
            ...
            className="group relative md:col-span-4 md:row-span-2 overflow-hidden rounded-3xl border border-black/5 dark:border-white/10 bg-gradient-to-br from-brand-50 via-white to-brand-100 dark:from-brand-400/10 dark:via-neutral-900 dark:to-brand-500/10 p-8"
          >
            ...
            <div className="absolute inset-y-0 right-0 w-[55%] flex items-center justify-center">
              <div className="relative h-[88%] w-[88%] transition-transform duration-700 group-hover:scale-105">
                <DataFlowGraphic />
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative md:col-span-2 row-span-2 overflow-hidden rounded-3xl border border-black/5 dark:border-white/10 bg-neutral-900"
          >
            <img
          ...
          <motion.div
            ...
            className="relative md:col-span-3 overflow-hidden rounded-3xl border border-black/5 dark:border-white/10 bg-white dark:bg-neutral-900/50 p-6 flex flex-col justify-between"
          >
            <div>
